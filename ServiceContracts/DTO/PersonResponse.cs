...
namespace ServiceContracts.DTO
{
	public class PersonResponse
	{
		...
		{
			return $"Person Name: {PersonName}, Email: {Email}, Date Of Birth: {DateOfBirth}, Gender: {Gender}, CountryId: {CountryID}, Country Name: {Country}, Address: {Address}, ReciveNewLetter: {ReceiveNewsLetters}, Age: {Age}"; 
		}
	...
	public static class PersonResponseExtensions
	{
		public static PersonResponse ToPersonResponse(this Person person)
		{
			return new PersonResponse() { PersonID = person.PersonID, PersonName = person.PersonName, 
				...
				Address = person.Address, ReceiveNewsLetters = person.ReceiveNewsLetters, 
				CountryID = person.CountryID, Age = 
				(person.DateOfBirth != null)? Math.Round((DateTime.Now - person.DateOfBirth.Value).TotalDays / 365.25) :null};
		}
	}
}
